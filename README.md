...
##### New version 1.4.5 allow easier and more complex processing of images from Opera Phenix Plus High-Content Screening System.
...
```
xml_file, metadata = operetta_annotation.xml_load('Images/Index.idx.xml')
```
...
<p align="center">
<img  src="https://raw.githubusercontent.com/jkubis96/Operetta_tool/main/fig/metadata.bmp" alt="drawing" width="600" />
</p>
...
```   
operetta_annotation.mage_concatenate(path_to_images, imgs, metadata, img_length, img_width, overlap, chanenls, n_thread) 
```
...
```   
resized_metadata = operetta_annotation.resize_tiff(channels, metadata, prefix = 'resized' , height = None, width = None, resize_factor = None)
```
...
```   
projection = operetta_annotation.z_projection(path_to_tiff, stack_check = True)
```
...
```
projection1 = operetta_annotation.z_projection('channel_ch1.tiff', stack_check = True)
...
<p align="center">
<img  src="https://raw.githubusercontent.com/jkubis96/Operetta_tool/main/fig/projection3.bmp" alt="drawing" width="600" />
</p>
...
```
merged_projection_scale = operetta_annotation.add_scalebar(merged_projection, metadata)
cv2.imwrite('merged_projection_scale.png', merged_projection_scale)
```

<p align="center">
<img  src="https://raw.githubusercontent.com/jkubis96/Operetta_tool/main/fig/scale%20bar.bmp" alt="drawing" width="600" />
</p>
...
```
numbers_of_pictures = operetta_annotation.image_grid('merged_projection.png', img_length, img_width)
```
...
```
operetta_annotation.split_channels(path_to_images, path_to_save)
```
...
```
operetta_annotation.select_pictures(imgs, 'Images', 'selected_images', numbers_of_pictures, ['ch2'])
```
