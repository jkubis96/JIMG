...
* [Download](https://www.mediafire.com/file/ozbp6is8pjqfgm6/JIMG-v.2.1.9.exe/file)
...
```
docker pull jkubis96/jimg:v2.1.9
```
...
```
docker run -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix:rw --rm jkubis96/jimg:v2.1.9
```
